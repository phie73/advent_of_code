...
solve("simple.txt", true);
solve("day16.txt", false);

void solve(string file, bool isTest)
{
    long solution1 = 1651;
    long solution2 = 1707;
    ...
    w(1, answer1, solution1, isTest);
    w(2, answer2, solution2, isTest);
}
